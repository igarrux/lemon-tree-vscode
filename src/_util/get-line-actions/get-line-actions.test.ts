...
describe("getLineActions", () => {
	let getDiagnosticsStub: any;
	let document: vscode.TextDocument;
	let range: vscode.Range;
	let fnRange: vscode.Range;

	beforeEach(() => {
		getDiagnosticsStub = vi.mocked(vscode.languages.getDiagnostics);
	...
	describe("when there are no diagnostics", () => {
		it("should return update and remove actions", () => {
			getDiagnosticsStub.mockReturnValue([]);
	...
	describe("when there are diagnostics but no errors", () => {
		it("should return update and remove actions for warnings", () => {
			...
			getDiagnosticsStub.mockReturnValue(diagnostics);
			...
			const diagnostics = [
				{
					range: {
						contains: vi
							.fn()
							.mockImplementation((pos: any) => pos === fnRange),
					},
					severity: vscode.DiagnosticSeverity.Error,
					message: "Error message",
				},
	...
	describe("error handling", () => {
		it("should return update and remove actions when getDiagnostics throws", () => {
			getDiagnosticsStub.mockImplementation(() => {
	...
	describe("edge cases", () => {
		...
		it("should handle null diagnostics", () => {
			getDiagnosticsStub.mockReturnValue(null);
		...
		it("should handle undefined diagnostics", () => {
			getDiagnosticsStub.mockReturnValue(undefined);
